...
2. Choose "Classic" template if you want full customisable features, or "Modern" template for one very estetic with some graphic customisations option like changing background etc... and full css edit. Here we will use the classic template.
3. After choosing "Classic" template, you can acces to the "Seetings" features. Choose [Advanced CSS Style Disign](http://myanimelist.net/editprofile.php?go=stylepref&do=cssadv).
4. If you don't have yet one, you can create a custom style (and one others max). Click in the style id and in the text box bellow, copy and past the CSS code of the style you want to use then save the change by clicking in "Update CSS" button bellow. 
